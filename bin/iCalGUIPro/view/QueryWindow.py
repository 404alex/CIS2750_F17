...
class QueryWindow(Tk):
    ...
    def makeQueryInputPanel(self):
        ...
        v = IntVar()
        v.set(1)
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=1, text='All events sorted by start date').grid(
            row=0, column=0, sticky='w')
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=2, text='Events by organizer name: ').grid(row=1,
                                                                                                              column=0,
                                                                                                              sticky='w')
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=3, text='Events by location: ').grid(row=2, column=0,
                                                                                                        sticky='w')
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=4, text='Contact info by organizer name: ').grid(
            row=3, column=0, sticky='w')
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=5, text='Event by alarm numbers: ').grid(row=4,
                                                                                                            column=0,
                                                                                                            sticky='w')
        Radiobutton(panelInsideDown, anchor='w', variable=v, value=5, text='Form by yourself: ').grid(row=5, column=0, sticky='w')
